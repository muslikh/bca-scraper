...
module.exports = {
  ...
  balance: () => {
    const options = {
      method: 'POST',
      uri: 'https://m.klikbca.com/balanceinquiry.do?value(page)=0',
      headers: {
  ...
  settlement: async (tglawal,blnawal,thnawal,tglakhir,blnakhir,thnakhir) => {
    const options = {
      method: 'POST',
      uri: 'https://m.klikbca.com/accountstmt.do?value(actions)=acctstmtview&value(actions)=acctstmtview',
      headers: {
    ...
    try {
      ...
      options.form = {
        ...
        'value(startDt)': tglawal,
        'value(startMt)': blnawal,
        'value(startYr)': thnawal,
        'value(endDt)': tglakhir,
        'value(endMt)': blnakhir,
        'value(endYr)': thnakhir,
      };
